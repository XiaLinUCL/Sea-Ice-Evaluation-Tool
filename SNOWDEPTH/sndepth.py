...
# 7) A script calls the functions 3) and 4) to plot the snow depth metrics
...
# --------------------------------------------------------
# PART 7) A script plots the snow depth metrics (heatmap) | 
# --------------------------------------------------------
...
Variables=['Mean Snow Depth North','Mean Snow Depth South','Mean Snow Depth North']
#Envisat&SnowModelLG
...
cbar.remove()
ax1.set_xticklabels(['Mean Snow Depth North','Mean Snow Depth South','Mean Snow Depth North'])
...
ax1.set_title("(b) Models vs Envisat and SnowModel-LG", fontname='Arial', fontsize=16)
plt.savefig('./7b_Metrics_sisnthick_Envisat_SnowModelLG.png', bbox_inches = "tight", dpi = 500)
